...
;;cedet插件设置
;;==================================================
(add-to-list 'load-path "~/install/cedet-1.0/cedet/lisp/speedbar")
(add-to-list 'load-path "~/install/cedet-1.0/cedet/lisp/eieio")
(add-to-list 'load-path "~/install/cedet-1.0/cedet/lisp/cedet/semantic/")
...
(load-file "~/install/cedet-1.0/cedet-devel-load.el")
(load-file "~/install/cedet-1.0/contrib/semantic-tag-folding.el")
